...
"Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, say so on the pull request and identify the parts You did not write, who owns them, and the licence they arrive under, so We can decide whether We are able to include them.
